...
@Component({
  selector: 'app-immediats',
  standalone: true,
  imports: [CommonModule,CheckboxModule,LottieModule, FormsModule,RadioButtonModule],
  templateUrl: './immediats.component.html',
  styleUrls: ['./immediats.component.scss']
})
export class ImmediatsComponent {

  free : string = 'notfree';
  // notFree : boolean = false;
